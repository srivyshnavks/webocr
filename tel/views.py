...
def index(request):
	if request.method == "GET":
		return render(request, 'tel/upload.html', {"result": False})
	...
	if request.method == "POST":
		...
		# OCR function call
		if type == "image":
			text = ocr.imgOcrTel(file_name)

		elif type == "pdf":
			text = str(ocr.pdfOcrTel(file_name))
		...
		return render(request, 'tel/upload.html', {"result": text})
