...
def index(request):
	if request.method == "GET":
		return render(request, 'eng/upload.html', {"result": False})
	...
	if request.method == "POST":
		...
		# OCR function call
		if type == "image":
			text = ocr.imgOcrEng(file_name)

		elif type == "pdf":
			text = ocr.pdfOcrEng(file_name)
		...
		return render(request, 'eng/upload.html', {"result": text})
