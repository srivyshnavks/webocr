...
def index(request):
	if request.method == "GET":
		return render(request, 'tam/upload.html', {"result": False})
	...
	if request.method == "POST":
		...
		# OCR function call
		if type == "image":
			text = ocr.imgOcrTam(file_name)

		elif type == "pdf":
			text = str(ocr.pdfOcrTam(file_name))
		...
		return render(request, 'tam/upload.html', {"result": text})
